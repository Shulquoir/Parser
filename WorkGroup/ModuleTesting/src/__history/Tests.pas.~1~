...
begin
  ...
  Assert.IsTrue(TModel.ContainsCyrillicCharacters('Привіт, світе!'));
end;
...
begin
  ...
  Assert.IsTrue(TModel.IsCharCyrillic('А'));
  Assert.IsTrue(TModel.IsCharCyrillic('а'));
  Assert.IsTrue(TModel.IsCharCyrillic('Я'));
  Assert.IsTrue(TModel.IsCharCyrillic('я'));
  Assert.IsTrue(TModel.IsCharCyrillic('Ё'));
  Assert.IsTrue(TModel.IsCharCyrillic('ё'));
end;
